      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-500">Services Down</p>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-500">Incidents Today</p>
      ...
      <div className="rounded-lg border border-gray-200 bg-white">
        ...
        <div className="p-6">
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="mt-1 text-sm text-gray-400">Activity will appear here as monitors report status changes</p>
          </div>
        </div>
      </div>
    </div>
